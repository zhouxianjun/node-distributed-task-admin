    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="#" class="logo">
                ...
                <span class="logo-mini">DTS</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg">Distributed Task System Admin</span>
            </a>

            <!-- Header Navbar: style can be found in header.less -->
            <nav class="navbar navbar-static-top" role="navigation">
                <!-- Sidebar toggle button-->
                <a href="#" @click="selfResize" class="sidebar-toggle" data-toggle="offcanvas" role="button">
